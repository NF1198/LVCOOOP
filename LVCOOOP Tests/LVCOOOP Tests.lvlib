...
<Library LVVersion="14008000">
	...
	<Item Name="Lookup API" Type="Folder">
		...
		<Item Name="Class C.lvclass" Type="LVClass" URL="../Lookup API/Class C.lvclass"/>
		<Item Name="Get Class A Instances.vi" Type="VI" URL="../Lookup API/Get Class A Instances.vi"/>
		<Item Name="Global Lookup.vi" Type="VI" URL="../Lookup API/Global Lookup.vi"/>
		<Item Name="Register Event Listener for Instances of A.vi" Type="VI" URL="../Lookup API/Register Event Listener for Instances of A.vi"/>
